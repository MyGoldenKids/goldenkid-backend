...
public interface ChildMapper {
    ...
    @Select("SELECT child_id, child_name, child_birth, child_gender, file_id from child where child_id = #{childId}")
    ...
    @Select("SELECT child_id, child_name, child_birth, child_gender, file_id from child where member_id = #{memberId}")
